...
class valueIdentification {
	protected static $table_name="value_identification";
	public $vi_id ;
	public $vi_desc;
  ...
  public static function find_by_id($vi_id=0) {
    $result_array = static::find_by_sql("SELECT * FROM ".self::$table_name." WHERE vi_id='{$vi_id}' LIMIT 1");
