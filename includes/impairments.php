...
<?php
class impairments {
	protected static $table_name="impairments";
	public $imp_id ;
	public $imp_des;
	public $imp_cat_id ;
  ...
  public static function find_by_id($imp_id=0) {
    $result_array = static::find_by_sql("SELECT * FROM ".self::$table_name." WHERE imp_id='{$imp_id}' LIMIT 1");
	return !empty($result_array) ? array_shift($result_array) : false;
  }
  public static function find_by_cat_id($imp_cat_id=0) {
    $result_array = static::find_by_sql("SELECT * FROM ".self::$table_name." WHERE imp_cat_id='{$imp_cat_id}'");
