...
<div class= "col-md-12 row">
      <div class="col col-md-12 text-center">
          <h5>Your current step--Getting to know you: Baseline 4/4</h5>
          <hr/> 
      </div>    
      <div class="col-md-8 order-md-1 text-left " role="tablist">

    <div class="card">

        <div id="collapseFive" class="collapse show" role="tabpanel"
    ...
    <div class="form-row mt-4">
          <div class="form-group col-md-12 text-right">
              <input role="button" type="button" class="btn btn-info float-right next-baseline_oh-btn" value="Next">
              <input role="button" type="button" class="baseline_oh-btn btn btn-success mr-2 float-right" value="Save">
              <input role="button" type="submit" value="Save" id="baseline_oh-save" name="saving-gtky" style="display: none">
              <small class="mr-2"
                     style="color: #999"> *You can save at any time and complete the form
                  later.
              </small>
              <a href="index_participant.php?cps=baseline_cr" class="btn btn-secondary float-left">Previous</a>
...
<script type="text/javascript">
    $(".next-baseline_oh-btn").click(function () {
        $("#cps").val("value");
        $("#baseline_oh-save").click();
    })

    $(".baseline_oh-btn").click(function () {
        $("#cps").val("baseline_oh");
        $("#baseline_oh-save").click();
    })
</script>
