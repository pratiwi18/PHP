...
$sql_imp_cat = "SELECT * FROM impairments_cat where imp_cat_id='2b'";
...
<div class= "col-md-12 row">
          ...
          <h5>Your current step--Getting to know you: Impairments 3/5</h5>
          <hr/> 
      </div>
  ...
  <div class="col-md-8 order-md-1 text-left" >
      ...
      <div class="form-group col-md-12 text-right mt-3">
          ...
          <input role="button" type="button" class="btn btn-info float-right next-impair_pf-btn" value="Next">

          <input role="button" type="button" class="impar_pf-btn btn btn-success mr-2 float-right" value="Save">
          <input role="button" type="submit" value="Save" id="impair_pf-save" name="saving-gtky" style="display: none">
...
<script type="text/javascript">
    $(".next-impair_pf-btn").click(function () {
        $("#cps").val("impair_be");
        $("#impair_pf-save").click();
    })

    $(".impar_pf-btn").click(function () {
        $("#cps").val("impair_pf");
        $("#impair_pf-save").click();
    })
</script>
