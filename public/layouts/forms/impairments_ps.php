...
$sql_imp_cat = "SELECT * FROM impairments_cat where imp_cat_id='2a'";
...
<div class= "col-md-12 row">
        <div class="col col-md-12 text-center">
          <h5>Your current step--Getting to know you: Impairments 2/5</h5>
          <hr/> 
      </div>
    <div class="col-md-8 order-md-1 text-left" >
      ...
      <div class="form-group col-md-12 text-right mt-3">
          ...
          <input role="button" type="button" class="btn btn-info float-right next-impair_ps-btn" value="Next">

          <input role="button" type="button" class="impar_p-btn btn btn-success mr-2 float-right" value="Save">
          <input role="button" type="submit" value="Save" id="impair_ps-save" name="saving-gtky" style="display: none">
          <small class="mr-2" style="color:#999"> *You can save at any time and complete the form later.</small>
          <a href="index_participant.php?cps=impair" class="btn btn-secondary float-left">Previous</a>
...
<script type="text/javascript">
    $(".next-impair_ps-btn").click(function () {
        $("#cps").val("impair_pf");
        $("#impair_ps-save").click();
    })

    $(".impar_ps-btn").click(function () {
        $("#cps").val("impair_ps");
        $("#impair_ps-save").click();
    })
</script>
