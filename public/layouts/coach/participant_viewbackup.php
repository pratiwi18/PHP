...
<div class="container">
  ...
  <div class="card mt-5 alert alert-info">
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-md-6">
          <td><a href="<?php echo ROOT_DIR."?pageid=message&paction=view&msgtype=msg&pid=".$participant->participantid?>" class="btn btn-info btn-sm" role="button">Message</a>
        </div>
        <div class="col-md-6">
          <td><a href="<?php echo ROOT_DIR."?pageid=message&paction=view&msgtype=alert&pid=".$participant->participantid?>" class="btn btn-warning btn-sm" role="button">Alert</a></td>
        </div>
       </div>
    </div>
  </div>
...
include_layout_template('coach/exercise_prescriptions_view.php');
?>
    </div>
    <div class="tab-pane fade" id="GS" role="tabpanel" aria-labelledby="GS-tab">
      <?php
// Loading goal setting tab
include_layout_template('coach/goal_setting_view.php');
?>
    </div>
  </div>
</div>
