<?php
if (isset($_GET['pid']) && ! empty($_GET['pid']) && isset($_GET['paction']) && ! empty($_GET['paction']) && $_GET['paction'] == 'update') {
...
<div class="container">
  ...
  <div class="card mt-5 alert alert-info">
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-md-6">
          <td><a href="<?php echo ROOT_DIR."?pageid=message&paction=modify&msgtype=msg&pid=".$participant->participantid?>" class="btn btn-info btn-sm" role="button">Messages</a>
        </div>
        <div class="col-md-6">
          <td><a href="<?php echo ROOT_DIR."?pageid=message&paction=modify&msgtype=alert&pid=".$participant->participantid?>" class="btn btn-warning btn-sm" role="button">Alert</a></td>
        </div>
       </div>
    </div>
  </div>
...
include_layout_template('coach/barriers_strategies.php');
?>
    </div>
...
include_layout_template('coach/goal_setting.php');
?>
    </div>
  </div>
</div>
