...
?>
<div class="container">
	<a class="btn btn-outline-dark" href="<?php echo ROOT_DIR."?pageid=home"?>">&laquo Back</a>
  <br>
  <br>
</div>
<div class="container">
...
<form class="form-inline mt-2 mt-md-0" method="get">
         <input type="hidden" value="participant_delete" name="pageid">
								...
								<div class="modal fade" id="modal<?php echo $participant->participantid;?>" tabindex="-1" role="dialog" aria-labelledby="modalLabel<?php echo $participant->participantid ?>" aria-hidden="true">
                  				...
                  				<span aria-hidden="true">&times;</span>
											...
											<div class="modal-footer">
												<form method="post" action="/coach_assistant/controller/delete_process.php">
	...
	function submitDeletePar() {
		...
		$.ajax({
			...
			success: function(response) {
				...
				if (response == "ok") {
					setTimeout(' window.location.href = "index.php?pageid=participant_delete"; ', 4000);
				} else {
					alert(response);
				}
			},
